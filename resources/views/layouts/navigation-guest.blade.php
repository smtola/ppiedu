<nav x-data="{open:false}" class="group sticky top-0 z-50 overflow-hidden">
    <div class="bg-[#7f3636] flex justify-between md:justify-center lg:justify-start items-start md:items-center md:gap-[2vw] p-5 w-full  transition-all duration-500 ease-in-out">
